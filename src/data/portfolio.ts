...
export const portfolioProjects: PortfolioProject[] = [
  {
    ...
    title: 'NOVAINT 인테리어',
    category: '인테리어',
    img: '/portfolio_img/NOVAINT.png',
    images: ['/portfolio_img/NOVAINT.png'],
  ...
  },
  {
    ...
    title: 'LINEO 기업 사이트',
    category: '기업 사이트',
    img: '/portfolio_img/기업사이트.png',
    images: ['/portfolio_img/기업사이트.png'],
  ...
  },
  {
    ...
    title: '리엔오 자산관리',
    category: '금융 · 자산관리',
    img: '/portfolio_img/리엔오.png',
    images: ['/portfolio_img/리엔오.png'],
  ...
  },
  {
    ...
    title: '드림다이브 스쿠버다이빙',
    category: '레저 · 스포츠',
    img: '/portfolio_img/드림다이브.png',
    images: ['/portfolio_img/드림다이브.png'],
  ...
  },
  {
    ...
    category: '물류 · 운송',
    img: '/portfolio_img/화물.png',
    images: ['/portfolio_img/화물.png'],
